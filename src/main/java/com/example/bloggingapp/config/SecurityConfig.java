...
@Configuration
@EnableWebSecurity
@EnableGlobalMethodSecurity(prePostEnabled = true) // this is to apply access to apis rolewise
@EnableWebMvc
@EnableSwagger2
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        // will not web based form after executing following code
        // can access apis via postman by selecting basic authentication
        http
                .csrf()
                .disable()
